			<div <?php if(dayBilder()){ ?>class="map_main_dg"<?php }else{if(hny()){ ?>class="map_hny"<?php }else{?>class="map"<?php }} ?> >
<?php if(!dayBilder()){ ?>
...
<?php $rand = rand(1,$count) ?>                          
                            latitude: <?php echo $selMainMap[$rand]["dolg"]; ?>+0.01,
                            longitude: <?php echo $selMainMap[$rand]["shir"]; ?>},
